...
def load_fourth_page():
    ...
    for i in range(407, 493):
        if i in [412,416,426,427,430,431,434,441,443,446,447,452,455,467,477,482,483,484]: # Ignore specific gatas
            fill_gehu_entry(i)
            continue
...
def fill_gehu_entry(i):
    ...
    try:
        ...
        time.sleep(0.5)
        Select(driver.find_element(By.ID, "fasal_name")).select_by_value(GEHU_FASAL_NAME_VALUE)
        time.sleep(1)
